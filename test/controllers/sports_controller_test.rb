...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { ans: @sport.ans, option1: @sport.option1, option2: @sport.option2, option3: @sport.option3, option4: @sport.option4, question: @sport.question } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { ans: @sport.ans, option1: @sport.option1, option2: @sport.option2, option3: @sport.option3, option4: @sport.option4, question: @sport.question } }
